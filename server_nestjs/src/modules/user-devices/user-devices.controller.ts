...
export class UserDevicesController {
  ...
  @Get()
  @ApiOkResponse({ description: 'Get user devices', example: USER_DEVICE_OK_RESPONSE_EXAMPLE })
  ...
  @UseGuards(JwtAuthGuard)
  @Delete(':deviceId')
  @ApiOkResponse({ description: 'Delete certain device by deviceId', example: true })
  @ApiUnauthorizedResponse({ description: 'Access denied' })
  async removeDevice(
    @Req() req: Request,
